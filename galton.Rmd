---
title: "Projeto nr. 01 - Altura dos filhos versus altura dos pais"
...
Dados utilizados por Francis Galton na análise da altura dos filhos em comparação à altura dos pais. A famosa comparação de Galton das alturas de 928 filhos adultos com as de seus 205 pares de pais (pai e mãe).
Quando os pais são mais altos que a média, seus filhos tendem a ser mais baixos (ou seja, mais próximos da média) e quando os pais são mais baixos que a média, seus filhos tendem a ser mais altos. Galton chamou isso de "regressão à mediocridade".
...
Como os dados estão estão em polegadas e no Brasil trabalhamos com centímetros, o primeiro passo é converter os dados. Uma polegada equivale a aproximadamente 2,54cm.
